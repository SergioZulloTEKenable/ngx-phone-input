# International Telephone Input for Angular (DRAFT)
## Work in PROGRESS

This is a clone of the original (ngx-intl-tel-input) with adding the ngx-bootstrap bootstrap module to avoid additional dependecy
will be a starting point, cause the plan is to remove the dependency. 
